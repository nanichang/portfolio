...
<head>
  ...
  <!-- Twitter Meta -->
  <meta name="twitter:site" content="@nanichangK">
  <meta name="twitter:creator" content="@nanichangK">
...
<body id="menu" class="body-page">
  ...
  <main class="page-main page-fullpage main-anim" id="mainpage">
    ...
    <div class="section section-home fullscreen-md fp-auto-height-responsive main-home border-sm section-centered"
    data-section="home">
            ...
            <div class="col-12 col-lg-6 text-left center-v">
              <div class="wrapper">
                ...
                <div class="title-desc">
                  ...
                  I possess more than two (2) years of progressive experience in the Web Development field. My professional history includes positions such as a remote Front-End developer at TELIOS Support Services <a href="https://tssdevs.com" target="_blank">(https://tssdevs.com)</a> as well as Software Developper at nHub Nigeria.
                  </p>
                </div>
    ...
    <div class="section section-twoside services-slider fp-auto-height-responsive anim-slide "
    data-section="services">
      <div class="slide">
        <div class="slide-wrapper">
          <div class="item-wrapper anim">
            <div class="legend section-content">
              <div class="legend-bg bg-color bg-gradient-orange"></div>
      ...
      <div class="slide">
        <div class="slide-wrapper">
          <div class="item-wrapper anim">
            <div class="legend section-content">
              <div class="legend-bg bg-color bg-gradient-green"></div>
              <div class="legend-text padding-wrapper-topbottom">
                <div class="row">
                  <div class="col-12 col-lg-6">
                    <div class="title-desc">
      ...
      <div class="slide">
        <div class="slide-wrapper">
          <div class="item-wrapper anim">
            <div class="legend section-content">
              <div class="legend-bg bg-color bg-gradient-aqua"></div>
              <div class="legend-text padding-wrapper-topbottom">
                <div class="row">
                  <div class="col-12 col-lg-6">
                    <div class="title-desc">
    ...
    <div class="section section-description fp-auto-height-responsive " data-section="about-performance">
          ...
          method="post" action="">
            ...
            <div class="form-input">
              <div class="form-group form-success-gone">
                ...
                <div class="f-input">
                  <input id="reg-email" name="email" class="form-control form-control-outline form-control-white"
